...
@DomainObject(
        ...
        objectType = "incodeCommunications.CommChannelRole"
)
@DomainObjectLayout(
...
public class CommChannelRole<T extends CommChannelRole> implements Comparable<T> {
    ...
    public static class TitleSubscriber extends AbstractSubscriber {
        ...
        private TranslatableString titleOf(final CommChannelRole role) {
            return TranslatableString.tr("{type} {channel}", "{type}", role.getType().name(), role.getChannel().getName());
        }
    }
