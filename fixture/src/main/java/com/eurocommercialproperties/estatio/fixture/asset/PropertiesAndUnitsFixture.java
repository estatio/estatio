...
public class PropertiesAndUnitsFixture extends AbstractFixture {
    ...
    @Override
    public void install() {
        Property prop1 = createPropertyAndUnits("OXF", "Oxford Super Mall", PropertyType.COMMERCIAL, 3, new Date(1999, 1, 1), new Date(2008, 6, 1), parties.findOrganisationByReference("HELLOWORLD"));
        ...
        Property prop2 = createPropertyAndUnits("KAL", "Winkelcentrum Kalvertoren", PropertyType.COMMERCIAL, 4, new Date(2003, 12, 1), new Date(2003, 12, 1), parties.findOrganisationByReference("ACME"));
    ...
    private Property createPropertyAndUnits(final String reference, String name, PropertyType type, int numberOfUnits, Date openingDate, Date acquireDate, Party owner) {
        Property property = properties.newProperty(reference, name, type);
        property.setOpeningDate(openingDate);
        property.setAcquireDate(acquireDate);
        property.addActor(owner, PropertyActorType.PROPERTY_OWNER, new Date(1999, 1, 1), new Date(2000, 1, 1));
