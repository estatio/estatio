...
public class PropertiesAndUnitsForKal extends PropertiesAndUnitsAbstract {

    @Override
    protected void execute(ExecutionContext executionContext) {
        Party owner = parties.findPartyByReference("ACME");
        ...
        Property property = createPropertyAndUnits(
                "KAL", "Kalvertoren", "Amsterdam", country, PropertyType.SHOPPING_CENTER, 40,
