...
public class PropertiesAndUnitsFixture extends SimpleFixtureScript {
    ...
    protected void doRun(String parameters, FixtureResultList fixtureResults) {
        ...
        Property prop1 = createPropertyAndUnits("OXF", "Oxford Super Mall", "Oxford", country, PropertyType.SHOPPING_CENTER, 25, new LocalDate(1999, 1, 1), new LocalDate(2008, 6, 1), owner1, manager, 51.74579, -1.24334, fixtureResults);
        ...
        Property prop2 = createPropertyAndUnits("KAL", "Kalvertoren", "Amsterdam", country, PropertyType.SHOPPING_CENTER, 40, new LocalDate(2003, 12, 1), new LocalDate(2003, 12, 1), owner2, manager, 52.37597, 4.90814, fixtureResults);
    ...
    private Property createPropertyAndUnits(final String reference, String name, String city, Country country, PropertyType type, int numberOfUnits, LocalDate openingDate, LocalDate acquireDate, Party owner, Party manager, double lat, double lng, FixtureResultList fixtureResults) {
