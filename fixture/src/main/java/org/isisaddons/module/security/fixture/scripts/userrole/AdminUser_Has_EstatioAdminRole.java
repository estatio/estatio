...
public class AdminUser_Has_EstatioAdminRole extends AbstractUserRoleFixtureScript {
    public AdminUser_Has_EstatioAdminRole() {
        super(AdminUser.USER_NAME, EstatioAdminRoleAndPermissions.ROLE_NAME);
    }
}
