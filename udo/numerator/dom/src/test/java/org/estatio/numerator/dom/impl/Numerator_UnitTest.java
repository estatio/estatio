...
public class Numerator_UnitTest {
    ...
    public static class Increment extends Numerator_UnitTest {
    ...
    public static class Title extends Numerator_UnitTest {
    ...
    public static class Format extends Numerator_UnitTest {
        @Test
        public void happyCase() {
            assertEquals("XXX-00001", numerator.format(BigInteger.ONE));
        }
    ...
    public static class AppTenancyPathAdaption extends Numerator_UnitTest {
