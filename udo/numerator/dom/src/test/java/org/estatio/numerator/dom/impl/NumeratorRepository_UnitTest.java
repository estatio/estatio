...
public class NumeratorRepository_UnitTest {
    ...
    public static class FindScopedNumerator extends NumeratorRepository_UnitTest {
    ...
    public static class AllNumerators extends NumeratorRepository_UnitTest {
