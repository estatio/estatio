...
public class AgreementRoleCommunicationChannelType_UnitTest {
    ...
    public static class MatchingCommunicationChannel extends AgreementRoleCommunicationChannelType_UnitTest {
