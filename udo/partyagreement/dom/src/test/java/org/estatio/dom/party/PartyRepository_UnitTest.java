...
public class PartyRepository_UnitTest {
    ...
    public static class MatchPartyByReferenceOrName extends PartyRepository_UnitTest {
        @Test
    ...
    public static class FindParties extends PartyRepository_UnitTest {
    ...
    public static class AllParties extends PartyRepository_UnitTest {
    ...
    public static class ValidateNewParty extends OrganisationRepository_UnitTest {
