...
public class Agreement_UnitTest {
    ...
    public static class FindCurrentOrMostRecentParty extends Agreement_UnitTest {
    ...
    public static class FindParty extends Agreement_UnitTest {
    ...
    public static class FindRole extends Agreement_UnitTest {
    ...
    public static class IsCurrent extends Agreement_UnitTest {
    ...
    public static class NewRole extends Agreement_UnitTest {
