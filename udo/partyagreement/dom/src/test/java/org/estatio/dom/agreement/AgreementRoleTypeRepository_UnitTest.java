...
public class AgreementRoleTypeRepository_UnitTest {
    ...
    public static class FindApplicableTo extends AgreementRoleTypeRepository_UnitTest {
    ...
    public static class FindByTitle extends AgreementRoleTypeRepository_UnitTest {
