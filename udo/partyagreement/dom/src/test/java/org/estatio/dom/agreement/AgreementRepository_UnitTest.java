...
public class AgreementRepository_UnitTest {
    ...
    public static class FindByAgreementTypeAndRoleTypeAndParty extends AgreementRepository_UnitTest {
    ...
    public static class FindByTypeAndReferenceOrName extends AgreementRepository_UnitTest {
