...
public class ChargeRepository_UnitTest {
    ...
    public static class FindByAtPathAndReference extends ChargeRepository_UnitTest {
    ...
    public static class AllChargeGroups extends ChargeRepository_UnitTest {
    ...
    public static class NewCharge extends ChargeRepository_UnitTest {
