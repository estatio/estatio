...
public class TaxRepository_UnitTest {
    ...
    public static class FindByReference extends TaxRepository_UnitTest {
        @Test
    ...
    public static class AllTaxes extends TaxRepository_UnitTest {
