 ...
 */
public abstract class WithApplicationTenancyDefinedLevelsContractTestAbstract {

    private final String packagePrefix;
    private Map<Class<?>, Class<?>> noninstantiableSubstitutes;

    protected WithApplicationTenancyDefinedLevelsContractTestAbstract(String packagePrefix,
