...
public class ApplicationTenancyLevel_UnitTest {

    static ApplicationTenancyLevel atl(String path) {
        return new ApplicationTenancyLevel(path);
    }

    public static class ParentOf_and_ChildOf extends ApplicationTenancyLevel_UnitTest {
    ...
    public static class GetParts extends ApplicationTenancyLevel_UnitTest {
    ...
    public static class Parent extends ApplicationTenancyLevel_UnitTest {
    ...
    public static class Child extends ApplicationTenancyLevel_UnitTest {
    ...
    public static class IsXxx extends ApplicationTenancyLevel_UnitTest {
    ...
    public static class GetCountryPath extends ApplicationTenancyLevel_UnitTest {
    ...
    public static class ParentOf extends ApplicationTenancyLevel_UnitTest {
    ...
    public static class ChildOf extends ApplicationTenancyLevel_UnitTest {
    ...
    public static class PeerOf extends ApplicationTenancyLevel_UnitTest {
    ...
    public static class PredicatesTest extends ApplicationTenancyLevel_UnitTest {
