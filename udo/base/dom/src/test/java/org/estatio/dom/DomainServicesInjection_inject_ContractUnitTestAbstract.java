 ...
 */
public abstract class DomainServicesInjection_inject_ContractUnitTestAbstract {

    private final String prefix;

    protected DomainServicesInjection_inject_ContractUnitTestAbstract(final String prefix) {
        this.prefix = prefix;
    }
