...
public class UdoDomainRepositoryAndFactory_UnitTest {

    public static class AllInstances_etc extends UdoDomainRepositoryAndFactory_UnitTest {
    ...
    public static class GetId_and_IconName extends UdoDomainRepositoryAndFactory_UnitTest {
    ...
    public static class NewQueryDefault extends UdoDomainRepositoryAndFactory_UnitTest {
