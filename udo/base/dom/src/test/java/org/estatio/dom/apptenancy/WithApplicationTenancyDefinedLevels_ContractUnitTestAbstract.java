 ...
 */
public abstract class WithApplicationTenancyDefinedLevels_ContractUnitTestAbstract {

    private final String packagePrefix;
    private Map<Class<?>, Class<?>> noninstantiableSubstitutes;

    protected WithApplicationTenancyDefinedLevels_ContractUnitTestAbstract(String packagePrefix,
