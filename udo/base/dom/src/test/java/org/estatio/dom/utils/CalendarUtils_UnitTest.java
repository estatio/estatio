...
public class CalendarUtils_UnitTest {

    public static class IntervalContaining extends CalendarUtils_UnitTest {
    ...
    public static class IntervalMatching extends CalendarUtils_UnitTest {
    ...
    public static class CurrentInterval extends CalendarUtils_UnitTest {
    ...
    public static class IntervalsInRange extends CalendarUtils_UnitTest {
    ...
    public static class NextDate extends CalendarUtils_UnitTest {
