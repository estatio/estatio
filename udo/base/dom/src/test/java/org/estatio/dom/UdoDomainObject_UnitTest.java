...
public class UdoDomainObject_UnitTest {

    public static class InjectClockService extends UdoDomainObject_UnitTest {
    ...
    public static class ToString extends UdoDomainObject_UnitTest {
