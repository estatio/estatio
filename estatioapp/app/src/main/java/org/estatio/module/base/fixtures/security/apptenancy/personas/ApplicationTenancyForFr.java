...
public class ApplicationTenancyForFr extends AbstractApplicationTenancyFixtureScript {

    public static final ApplicationTenancy_enum data = ApplicationTenancy_enum.Fr;
