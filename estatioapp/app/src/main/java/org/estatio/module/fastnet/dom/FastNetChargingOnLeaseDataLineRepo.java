...
public class FastNetChargingOnLeaseDataLineRepo extends UdoDomainRepositoryAndFactory<FastNetChargingOnLeaseDataLine> {

    public FastNetChargingOnLeaseDataLineRepo() {
        super(FastNetChargingOnLeaseDataLineRepo.class, FastNetChargingOnLeaseDataLine.class);
    }
