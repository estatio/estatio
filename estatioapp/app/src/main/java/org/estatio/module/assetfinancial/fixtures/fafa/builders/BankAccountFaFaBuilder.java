...
@EqualsAndHashCode(of={"bankAccount", "property"})
@Accessors(chain = true)
public class BankAccountFaFaBuilder extends BuilderScriptAbstract<BankAccountFaFaBuilder> {
    ...
    protected void execute(final ExecutionContext executionContext) {
        ...
        fixedAssetFinancialAccount = fixedAssetFinancialAccountRepository.newFixedAssetFinancialAccount(property, bankAccount);
    }
