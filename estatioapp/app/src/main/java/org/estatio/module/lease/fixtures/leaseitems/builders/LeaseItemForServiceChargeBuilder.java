...
public class LeaseItemForServiceChargeBuilder extends BuilderScriptAbstract<LeaseItem, LeaseItemForServiceChargeBuilder> {

    public static final LeaseItemType LEASE_ITEM_TYPE = LeaseItemType.SERVICE_CHARGE;
    ...
    @Getter @Setter List<LeaseTermForServiceChargeBuilder.TermSpec> termSpecs = Lists.newArrayList();

    @Getter LeaseItem object;
    @Getter @Setter List<LeaseTermForServiceCharge> terms = Lists.newArrayList();
    ...
    protected void execute(final ExecutionContext ec) {
        ...
        for (LeaseTermForServiceChargeBuilder.TermSpec termSpec : termSpecs) {
            final LeaseTermForServiceCharge term = new LeaseTermForServiceChargeBuilder()
                    ...
                    .setBudgetedValue(termSpec.budgetedValue)
                    .build(this, ec)
                    .getObject();
            terms.add(term);
        }
