...
public class EstatioAdmin_Has_TogglzAdminRole extends AbstractUserRoleFixtureScript {
    public EstatioAdmin_Has_TogglzAdminRole() {
        super(EstatioAdmin.USER_NAME, TogglzModuleAdminRole.ROLE_NAME);
    }
}
