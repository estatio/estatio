...
public enum LeaseItemForDiscount_enum implements PersonaWithFinder<LeaseItem>, PersonaWithBuilderScript<LeaseItem, LeaseItemForDiscountBuilder> {

    OxfMiracle005bGb(Lease_enum.OxfMiracl005Gb, bi(1), LeaseItemForRent_enum.OxfMiracl005Gb,
        new TermSpec[]{
            new TermSpec(Lease_enum.OxfMiracl005Gb.getStartDate(), Lease_enum.OxfMiracl005Gb.getStartDate().plusYears(1), null, bd(-20000))
        }),
    ...
    @Override
    public LeaseItemForDiscountBuilder builder() {
        return new LeaseItemForDiscountBuilder()
