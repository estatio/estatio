...
public class PropertyAndUnitsAndOwnerAndManagerForKalNl extends PropertyAndUnitsAndOwnerAndManagerAbstract {
    ...
    public static final PropertyAndUnitsAndOwnerAndManager_enum data = PropertyAndUnitsAndOwnerAndManager_enum.KalNl;

    public static final String REF = data.getRef();
    public static final String PARTY_REF_MANAGER = data.getManager_d().getRef();

    public PropertyAndUnitsAndOwnerAndManagerForKalNl() {
        super(data);
    }
