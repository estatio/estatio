...
public enum Budget_enum implements PersonaWithBuilderScript<Budget, BudgetBuilder>, PersonaWithFinder<Budget> {
    ...
    OxfDirectCostBudget2015(
            PropertyAndUnitsAndOwnerAndManager_enum.OxfGb, ld(2015, 1, 1),
            new ItemSpec[]{
                    new ItemSpec(Charge_enum.GbIncomingCharge1, bd("1000.00"))
            }
    ),
    BudBudget2015(
    ...
    RonItaBudget2016UnitAreaDivided(
            PropertyAndUnitsAndOwnerAndManager_enum.RonItDiv, ld(2016, 1, 1),
            new ItemSpec[]{
                    new ItemSpec(Charge_enum.ItServiceCharge, bd("10000.00"))
            }
    ),
    RonItaBudget2018(
            PropertyAndUnitsAndOwnerAndManager_enum.RonIt, ld(2018, 1, 1),
            new ItemSpec[]{
            }
    ),
    ;
