 ...
 */
@Mixin(method = "act")
public class IncomingDocAsInvoiceViewModel_adviseToApprove extends IncomingInvoice_adviseToApprove {

    private final IncomingDocAsInvoiceViewModel viewModel;

    public IncomingDocAsInvoiceViewModel_adviseToApprove(final IncomingDocAsInvoiceViewModel viewModel) {
        super(viewModel.getDomainObject());
        this.viewModel = viewModel;
    }

    public static class ActionDomainEvent
        extends IncomingInvoice_triggerAbstract.ActionDomainEvent<IncomingDocAsInvoiceViewModel_adviseToApprove> {}
