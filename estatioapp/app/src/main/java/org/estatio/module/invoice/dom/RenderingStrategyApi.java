...
public interface RenderingStrategyApi {

    Renderer newRenderer(final ClassService classService, final ServiceRegistry2 serviceRegistry2);

    boolean isPreviewsToUrl();

    DocumentNature getInputNature();

    DocumentNature getOutputNature();
}
