...
public class LeaseTermForPercentageBuilder
        extends BuilderScriptAbstract<LeaseTermForPercentage, LeaseTermForPercentageBuilder> {

    @Getter @Setter LeaseItem leaseItem;
    @Getter @Setter LocalDate startDate;

    @Getter @Setter LocalDate endDate;
    @Getter @Setter BigDecimal percentage;
    @Getter @Setter LeaseTermFrequency leaseTermFrequency;

    @Getter LeaseTermForPercentage object;
    ...
    protected void execute(final ExecutionContext ec) {
        ...
        checkParam("percentage", ec, BigDecimal.class);

        defaultParam("leaseTermFrequency", ec, LeaseTermFrequency.YEARLY);

        final Class<?> expectedClass = LeaseTermForPercentage.class;
