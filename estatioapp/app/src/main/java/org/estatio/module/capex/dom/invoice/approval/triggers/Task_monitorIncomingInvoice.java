 ...
 */
@Mixin(method = "act")
public class Task_monitorIncomingInvoice
        extends Task_mixinIncomingInvoiceAbstract<IncomingInvoice_monitor> {

    protected final Task task;

    public Task_monitorIncomingInvoice(final Task task) {
        super(task, IncomingInvoice_monitor.class);
        this.task = task;
    }

    public static class ActionDomainEvent
            extends Task_mixinIncomingInvoiceAbstract.ActionDomainEvent<Task_monitorIncomingInvoice> { }
