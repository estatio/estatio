...
public class LeaseItemForTaxBuilder extends BuilderScriptAbstract<LeaseItem, LeaseItemForTaxBuilder> {

    public static final LeaseItemType LEASE_ITEM_TYPE = LeaseItemType.TAX;
    ...
    @Getter @Setter List<LeaseTermForTaxBuilder.TermSpec> termSpecs = Lists.newArrayList();

    @Getter LeaseItem object;
    @Getter List<LeaseTermForTax> terms = Lists.newArrayList();
    ...
    protected void execute(final ExecutionContext ec) {
        ...
        for (LeaseTermForTaxBuilder.TermSpec termSpec : termSpecs) {
            final LeaseTermForTax term = new LeaseTermForTaxBuilder()
                    ...
                    .setTaxPercentage(termSpec.taxPercentage)
                    .setRecoverablePercentage(termSpec.recoverablePercentage)
                    .setTaxable(termSpec.taxable)
                    .build(this, ec)
                    .getObject();
            terms.add(term);
        }
