...
public class PropertyAndUnitsAndOwnerAndManagerForGraIt extends PropertyAndUnitsAndOwnerAndManagerAbstract {
    ...
    public static final PropertyAndUnitsAndOwnerAndManager_enum data = PropertyAndUnitsAndOwnerAndManager_enum.GraIt;

    public static final String REF = data.getRef();
    public static final String PARTY_REF_MANAGER = data.getManager_d().getRef();

    public PropertyAndUnitsAndOwnerAndManagerForGraIt() {
        super(data);
    }
