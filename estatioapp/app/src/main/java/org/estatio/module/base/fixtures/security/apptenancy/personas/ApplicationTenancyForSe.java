...
public class ApplicationTenancyForSe extends AbstractApplicationTenancyFixtureScript {

    public static final ApplicationTenancy_enum data = ApplicationTenancy_enum.Se;
