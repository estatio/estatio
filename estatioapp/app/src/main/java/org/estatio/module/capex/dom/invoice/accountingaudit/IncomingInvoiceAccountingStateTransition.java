...
@PersistenceCapable(
        ...
        schema = "dbo",
        table = "IncomingInvoiceAccountingStateTransition"
)
@DatastoreIdentity(
...
@Queries({
        @Query(
                ...
                value = "SELECT "
                        + "FROM org.estatio.module.capex.dom.invoice.accountingaudit.IncomingInvoiceAccountingStateTransition "
...
@DomainObject(objectType = "incomingInvoice.IncomingInvoiceAccountingStateTransition" )
public class IncomingInvoiceAccountingStateTransition
    ...
    @Getter @Setter
    private IncomingInvoiceAccountingState fromState;

    @Column(allowsNull = "false")
    @Getter @Setter
    private IncomingInvoiceAccountingStateTransitionType transitionType;
    ...
    @Getter @Setter
    private IncomingInvoiceAccountingState toState;
    ...
    @DomainService(
            ...
            repositoryFor = IncomingInvoiceAccountingStateTransition.class
    )
    public static class Repository
        ...
        public Repository() {
            super(IncomingInvoiceAccountingStateTransition.class);
        }
