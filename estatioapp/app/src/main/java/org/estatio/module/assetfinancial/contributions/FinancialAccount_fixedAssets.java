...
@Mixin(method = "coll")
public class FinancialAccount_fixedAssets  {

    private final FinancialAccount financialAccount;

    public FinancialAccount_fixedAssets(final FinancialAccount financialAccount) {
    ...
    public List<FixedAssetFinancialAccount> coll() {
        return fixedAssetFinancialAccountContributions.fixedAssets(this.financialAccount);
    }
