...
public class LeaseItemForServiceChargeBudgetedBuilder extends BuilderScriptAbstract<LeaseItem, LeaseItemForServiceChargeBudgetedBuilder> {

    public static final LeaseItemType LEASE_ITEM_TYPE = LeaseItemType.SERVICE_CHARGE_BUDGETED;
    ...
    protected void execute(final ExecutionContext ec) {
        ...
        final LeaseItem leaseItem = new LeaseItemBuilder()
            .setLease(lease)
            .setCharge(charge)
