...
@Mixin(method = "act")
public class IncomingInvoice_reAudit extends IncomingInvoice_triggerAbstract {

    private final IncomingInvoice incomingInvoice;

    public IncomingInvoice_reAudit(IncomingInvoice incomingInvoice) {
        super(incomingInvoice, IncomingInvoiceAccountingStateTransitionType.RE_AUDIT);
        this.incomingInvoice = incomingInvoice;
    }

    public static class ActionDomainEvent
            extends IncomingInvoice_triggerAbstract.ActionDomainEvent<IncomingInvoice_reAudit> {}
