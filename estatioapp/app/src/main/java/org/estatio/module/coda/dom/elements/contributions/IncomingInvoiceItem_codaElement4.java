...
@Mixin
public class IncomingInvoiceItem_codaElement4 {

    private final IncomingInvoiceItem item;

    public IncomingInvoiceItem_codaElement4(IncomingInvoiceItem item) {
        this.item = item;
    }
    ...
    public CodaElement $$() {
        ...
        return link!=null ? link.getCodaElement4() : null;
    }
