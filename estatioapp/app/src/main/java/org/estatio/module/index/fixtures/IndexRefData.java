 ...
 *  under the License.
 */
package org.estatio.module.index.fixtures;
...
public class IndexRefData extends FixtureScript {
    ...
    public static final Index_enum data = Index_enum.IStatFoi;
...
//
//        final Index index = createIndex(applicationTenancy, data.getReference(), data.getName(), executionContext);
//
//        final IndexBase base1989 = createIndexBase(index, null, 1990, 1.242, executionContext);
//
...
//
//        final IndexBase base1992 = createIndexBase(index, base1989, 1993, 1.189, executionContext);
...
//
//        final IndexBase base1995 = createIndexBase(index, base1992, 1996, 1.141, executionContext);
...
//
//        final IndexBase base2000 = createIndexBase(index, base1995, 2011, 1.373, executionContext);
