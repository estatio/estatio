...
public class LeaseItemForDiscountBuilder extends BuilderScriptAbstract<LeaseItem, LeaseItemForDiscountBuilder> {

    public static final LeaseItemType LEASE_ITEM_TYPE = LeaseItemType.RENT_DISCOUNT_FIXED;
