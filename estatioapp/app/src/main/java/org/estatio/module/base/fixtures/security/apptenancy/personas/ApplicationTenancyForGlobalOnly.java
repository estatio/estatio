...
public class ApplicationTenancyForGlobalOnly extends AbstractApplicationTenancyFixtureScript {

    public static final ApplicationTenancy_enum data = ApplicationTenancy_enum.GlobalOnly;
