...
@Programmatic
public class LeaseAmendmentImportFixture extends FixtureScript {
    ...
    protected void execute(final ExecutionContext executionContext) {
        ...
        try {
            excelBytes = Resources.toByteArray(Resources.getResource(getClass(), "lease_amendment_import.xlsx"));
