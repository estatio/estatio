...
public class DocumentTemplateMenu extends UdoDomainService<DocumentTemplateMenu> {
    ...
    public DocumentTemplate newClobTemplate(
        ...
        final Clob clob = new Clob(documentName, mimeType, templateText);
        return documentTemplateRepository.createClob(type, applicationTenancy.getPath(), clob, dataModelClassName);
    }

    public String default2NewClobTemplate() {
        return "text/html";
    }
