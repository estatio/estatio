 ...
 *  under the License.
 */
package org.isisaddons.module.xdocreport;
...
public final class IncodeLibXDocReportModule extends ModuleAbstract {

    @Override
    public Set<Class<?>> getAdditionalModules() {
        return Sets.newHashSet(XDocReportModule.class);
    }
