...
public class PropertyMenu2_UnitTest {
    ...
    public static class FindPropertyMenu extends PropertyMenu2_UnitTest {
    ...
    public static class FindPropertyByReference extends PropertyMenu2_UnitTest {
    ...
    public static class AutoComplete extends PropertyMenu2_UnitTest {
    ...
    public static class AllPropertyMenu extends PropertyMenu2_UnitTest {
    ...
    public static class NewProperty extends PropertyMenu2_UnitTest {
