...
public class UdoDomainRepositoryAndFactory_Test {

    public static class AllInstances_etc extends UdoDomainRepositoryAndFactory_Test {
    ...
    public static class GetId_and_IconName extends UdoDomainRepositoryAndFactory_Test {
    ...
    public static class NewQueryDefault extends UdoDomainRepositoryAndFactory_Test {
