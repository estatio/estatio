 ...
 */
public class UdoDomainObject2_Contract_Test {

    public static class JdoAnnotations extends UdoDomainObject2_Contract_Test {
        ...
        public void searchAndTest() {
            ...
            for (final Class<? extends UdoDomainObject> subtype : subtypes) {
                ...
                if (subtype.getName().equals("org.estatio.module.base.dom.UdoDomainObject2")) {
                    // skip
                    continue;
                }
