...
public class LeaseTermForIndexable_Test {
    ...
    public static class DoAlign extends LeaseTermForIndexable_Test {
    ...
    public static class ValueForDueDate extends LeaseTermForIndexable_Test {
    ...
    public static class DoInitialize extends LeaseTermForIndexable_Test {
