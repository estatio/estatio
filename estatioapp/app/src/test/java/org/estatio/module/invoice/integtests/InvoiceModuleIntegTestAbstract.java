...
public abstract class InvoiceModuleIntegTestAbstract extends BaseModuleIntegTestAbstract {

    public InvoiceModuleIntegTestAbstract() {
        super(new EstatioInvoiceModule());
    }
}