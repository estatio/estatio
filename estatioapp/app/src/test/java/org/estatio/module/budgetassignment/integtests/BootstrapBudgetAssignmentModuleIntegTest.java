...
public class BootstrapBudgetAssignmentModuleIntegTest extends BudgetAssignmentModuleIntegTestAbstract {

    @Test
    public void serializes_module() throws Exception {

        final EstatioBudgetAssignmentModule module = new EstatioBudgetAssignmentModule();
