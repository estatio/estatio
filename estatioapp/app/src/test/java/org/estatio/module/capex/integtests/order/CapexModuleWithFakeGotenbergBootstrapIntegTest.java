...
public class CapexModuleWithFakeGotenbergBootstrapIntegTest extends BaseModuleIntegTestAbstract {

    public CapexModuleWithFakeGotenbergBootstrapIntegTest() {
        super(new EstatioCapexModuleWithGotenbergFake());
    }
