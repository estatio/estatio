...
public class TurnoverImport_Test {
    ...
    public void getAmountDivPercentage() {
        ...
        turnoverImport.setGrossAmountPreviousYear(new BigDecimal("1000.00"));
        // then
        ...
        turnoverImport.setGrossAmount(new BigDecimal("1234.56"));
        ...
        turnoverImport.setGrossAmountPreviousYear(new BigDecimal("1234.56"));
        // then
        ...
        turnoverImport.setGrossAmountPreviousYear(new BigDecimal("1234.56"));
        turnoverImport.setGrossAmount(new BigDecimal("1000.00"));
        // then
