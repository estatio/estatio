        ...
        public void setupData() {
            runFixtureScript(new FixtureScript() {
                ...
                protected void execute(FixtureScript.ExecutionContext executionContext) {
                    ...
                    executionContext.executeChild(this, Person_enum.FaithConwayGb.toBuilderScript());  // gb (no role)
                    ...
                    executionContext.executeChild(this, Person_enum.RosaireEvrardFr.toBuilderScript());  // fr (no role)
