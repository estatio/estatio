...
public abstract class TurnoverAggregateModuleIntegTestAbstract extends BaseModuleIntegTestAbstract {

    public TurnoverAggregateModuleIntegTestAbstract() {
        super(new EstatioTurnoverAggregateModule());
    }
