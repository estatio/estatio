...
public class Agreement_Test {
    ...
    public static class FindCurrentOrMostRecentParty extends Agreement_Test {
    ...
    public static class FindRole extends Agreement_Test {
    ...
    public static class IsCurrent extends Agreement_Test {
    ...
    public static class NewRole extends Agreement_Test {
