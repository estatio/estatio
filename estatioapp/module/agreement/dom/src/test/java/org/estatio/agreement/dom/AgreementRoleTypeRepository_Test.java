...
public class AgreementRoleTypeRepository_Test {
    ...
    public static class FindApplicableTo extends AgreementRoleTypeRepository_Test {
    ...
    public static class FindByTitle extends AgreementRoleTypeRepository_Test {
