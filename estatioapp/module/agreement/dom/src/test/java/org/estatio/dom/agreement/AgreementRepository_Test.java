...
public class AgreementRepository_Test {
    ...
    public static class FindByAgreementTypeAndRoleTypeAndParty extends AgreementRepository_Test {
    ...
    public static class FindByTypeAndReferenceOrName extends AgreementRepository_Test {
