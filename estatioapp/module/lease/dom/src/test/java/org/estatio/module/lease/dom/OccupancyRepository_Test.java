...
public class OccupancyRepository_Test {
    ...
    public static class FindByLeaseAndUnitAndStartDate extends OccupancyRepository_Test {
        @Test
    ...
    public static class FindByLease extends OccupancyRepository_Test {
    }
    ...
    public static class FindByUnit extends OccupancyRepository_Test {
