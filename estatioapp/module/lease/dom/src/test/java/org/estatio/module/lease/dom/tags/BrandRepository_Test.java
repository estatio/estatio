...
public class BrandRepository_Test {
    ...
    public static class FindUnique extends BrandRepository_Test {
    ...
    public static class MatchByName extends BrandRepository_Test {
        @Test
    ...
    public static class FindByNameLowerCaseAndAppTenancy extends BrandRepository_Test {
    ...
    public static class AutoComplete extends BrandRepository_Test {
