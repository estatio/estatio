...
public class LeaseItemRepository_Test {
    ...
    public static class AllLeaseItems extends LeaseItemRepository_Test {
    ...
    public static class findByLeaseAndTypeAndCharge extends LeaseItemRepository_Test {
