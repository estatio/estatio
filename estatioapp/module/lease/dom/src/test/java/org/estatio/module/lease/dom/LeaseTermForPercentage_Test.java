...
public class LeaseTermForPercentage_Test {
    ...
    public static class DoAlign extends LeaseTermForPercentage_Test {
    ...
    public static class ValidateChangePercentage extends LeaseTermForPercentage_Test {
    ...
    public static class DoInitialize extends LeaseTermForPercentage_Test {
