...
public class IndexationMethod_Test {
    ...
    public static class DoInitialize extends IndexationMethod_Test {
    ...
    public static class DoAlign extends IndexationMethod_Test {
    ...
    public static class DoAlignWithChangingBaseRentNegativeIndexation extends IndexationMethod_Test {
    ...
    public static class DoAlignWithChangingBaseRentPositiveIndexation extends IndexationMethod_Test {
