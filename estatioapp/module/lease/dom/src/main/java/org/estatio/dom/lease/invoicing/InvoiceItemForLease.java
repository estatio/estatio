...
@javax.jdo.annotations.Discriminator(
        "org.estatio.dom.invoice.InvoiceItem" // backward compatibility, so don't have to migrate all bookmarks in auditing etc
        // (would rather use "lease.InvoiceItemForLease", but @Discriminator currently takes precedence over @DomainObject#objectType); see EST-1084
