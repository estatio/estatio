                                            ...
                                            <table class="twelve columns">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <br/>
                                                        <p>
                                                        Con la presente trasmettiamo in allegato <span class="emphasis">Avviso di fatturazione ${invoice.dueDate}.</span>
                                                        </p>
                                                        ...
                                                        <br/>
                                                        <p>
                                                        Please find attached the <span class="emphasis">Preliminary Letter ${invoice.dueDate}.</span>
                                                        </p>
