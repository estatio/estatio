...
public abstract class IndexModuleIntegTestAbstract extends IntegrationTestAbstract2 {
    ...
    @Before
    public void setup() {
        runFixtureScript(new EstatioIndexModule.Setup());
    ...
    public void tearDown() {
        ...
        runFixtureScript(new EstatioIndexModule.Teardown());
    }
