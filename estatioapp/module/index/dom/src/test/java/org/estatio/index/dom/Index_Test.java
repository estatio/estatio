...
public class Index_Test {
    ...
    public static class FactorForDate extends Index_Test {
    ...
    public static class GetIndexValueFactorForDate extends Index_Test {
    ...
    public static class GetRebaseFactorForDates extends Index_Test {
