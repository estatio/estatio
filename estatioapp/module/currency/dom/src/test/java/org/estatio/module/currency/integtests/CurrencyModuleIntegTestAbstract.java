...
public abstract class CurrencyModuleIntegTestAbstract extends IntegrationTestAbstract2 {
    ...
    @Before
    public void setup() {
        runFixtureScript(new EstatioCurrencyModule.Setup());
    ...
    public void tearDown() {
        ...
        runFixtureScript(new EstatioCurrencyModule.Teardown());
    }
