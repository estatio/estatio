 ...
 */
public abstract class PartyModuleIntegTestAbstract extends IntegrationTestAbstract2 {
    ...
    @Before
    public void setup() {
        runFixtureScript(new EstatioPartyModule.Setup());
    ...
    public void tearDown() {
        ...
        runFixtureScript(new EstatioPartyModule.Teardown());
    }
