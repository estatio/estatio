...
public abstract class ApplicationModuleIntegTestAbstract extends IntegrationTestAbstract2 {
    ...
    @Before
    public void setup() {
        runFixtureScript(new EstatioApplicationModule.Setup());
    ...
    public void tearDown() {
        ...
        runFixtureScript(new EstatioApplicationModule.Teardown());
    }
