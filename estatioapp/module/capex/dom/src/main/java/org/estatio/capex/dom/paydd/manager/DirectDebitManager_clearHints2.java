package org.estatio.capex.dom.paydd.manager;
 ...
 */
@Mixin(method = "act")
public class DirectDebitManager_clearHints2 {

    private final PaymentBatchManager object;

    public DirectDebitManager_clearHints2(PaymentBatchManager object) {
        this.object = object;
    }
