...
@DomainObject(
        objectType = "capex.CategorizeIncomingOrderViewModel"
)
...
public class CategorizeIncomingOrderViewModel extends HasDocumentAbstract {

    public CategorizeIncomingOrderViewModel() {}
    public CategorizeIncomingOrderViewModel(final IncomingDocumentViewModel viewModel) {
    ...
    public static class Subscriber extends AbstractSubscriber {
        ...
        public void on(HasDocument_all.ActionDomainEvent ev) {
            ...
            if(hasDocument instanceof CategorizeIncomingOrderViewModel) {
