...
public class ProjectContributions {
    ...
    public Project newProject(
        ...
        return projectRepository.newProject(reference, name, startDate, endDate, currency, estimatedCost, projectPhase, program);
    }
    ...
    public List<Project> projects(final Program program) {
        return projectRepository.findByProgram(program);
    }
