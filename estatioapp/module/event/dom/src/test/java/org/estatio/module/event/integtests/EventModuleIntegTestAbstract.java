...
public abstract class EventModuleIntegTestAbstract extends IntegrationTestAbstract2 {
    ...
    @Before
    public void setup() {
        runFixtureScript(new EstatioEventModule.Setup());
    ...
    public void tearDown() {
        ...
        runFixtureScript(new EstatioEventModule.Teardown());
    }
