...
public class UdoDomainObject_Test {

    public static class InjectClockService extends UdoDomainObject_Test {
    ...
    public static class ToString extends UdoDomainObject_Test {
