...
public abstract class BudgetModuleIntegTestAbstract extends IntegrationTestAbstract2 {
    ...
    @Before
    public void setup() {
        runFixtureScript(new EstatioBudgetModule.Setup());
    ...
    public void tearDown() {
        ...
        runFixtureScript(new EstatioBudgetModule.Teardown());
    }
