...
public class SchedulesForOxf extends ScheduleAbstact {
    ...
    protected void execute(ExecutionContext executionContext) {
        ...
        KeyTable keyTable1 = keyTableRepository.findByProperty(property).get(0);
        KeyTable keyTable2 = keyTableRepository.findByProperty(property).get(1);
        ...
        createScheduleItem(newschedule, keyTable1, budgetItem1, new BigDecimal(100));
        createScheduleItem(newschedule, keyTable1, budgetItem2, new BigDecimal(80));
        createScheduleItem(newschedule, keyTable2, budgetItem2, new BigDecimal(20));
    }
