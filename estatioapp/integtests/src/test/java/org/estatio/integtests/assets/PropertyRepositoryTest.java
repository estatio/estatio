...
public class PropertyRepositoryTest extends EstatioIntegrationTest {
    ...
    public static class AllPropertyRepository extends PropertyRepositoryTest {
    ...
    public static class FindPropertyRepository extends PropertyRepositoryTest {
    ...
    public static class FindPropertyByReference extends PropertyRepositoryTest {
    ...
    public static class NewProperty extends PropertyRepositoryTest {
