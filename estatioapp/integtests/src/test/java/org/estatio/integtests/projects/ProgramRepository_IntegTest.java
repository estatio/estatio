...
public class ProgramRepository_IntegTest extends EstatioIntegrationTest {
    ...
    public static class AllProgramRepository extends ProgramRepository_IntegTest {

        @Test
        public void returnAllPrograms() throws Exception {
            // when
            List<Program> allPrograms = programRepository.allPrograms();
    ...
    public static class FindProgramRepository extends ProgramRepository_IntegTest {

        @Test
        public void withReference() throws Exception {
            final List<Program> progs = programRepository.findProgram("KAL_P1");
            assertNotNull(progs);
        ...
        public void withName() throws Exception {
            final List<Program> progs = programRepository.findProgram("Program 1");
            assertNotNull(progs);
            assertThat(progs.size(), is(1));
        }
        ...
        public void withWildcard() throws Exception {
            final List<Program> progs = programRepository.findProgram("Pro*");
            assertNotNull(progs);
            assertThat(progs.size(), is(1));
        }
        ...
        public void withWildcard_returningMultiple() throws Exception {
            final List<Program> progs = programRepository.findProgram("*");
            assertNotNull(progs);
