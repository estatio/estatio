...
public class ProgramRoleRepository_IntegTest extends EstatioIntegrationTest {
    ...
    public static class FindRole extends ProgramRoleRepository_IntegTest {
    ...
    public static class newProgramRole extends ProgramRoleRepository_IntegTest {
    ...
    public static class changeProgramRoleDates extends ProgramRoleRepository_IntegTest {
    ...
    public static class OnPartyRemove extends ProgramRoleRepository_IntegTest {
