...
public class BusinessCaseRepositoryTest extends EstatioIntegrationTest {
    ...
    public static class newBusinessCase extends BusinessCaseRepositoryTest {
    ...
    public static class newBusinessCaseValidation extends BusinessCaseRepositoryTest {
    ...
    public static class updateBusinessCase extends BusinessCaseRepositoryTest {
    ...
    public static class updateBusinessCaseValidation extends BusinessCaseRepositoryTest {
