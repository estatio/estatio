...
public class VetoDeleteOfIncomingDocumentIfCategorised_IntegTest extends EstatioIntegrationTest {
    ...
    public void setupData() throws IOException {
        ...
        final byte[] pdfBytes = Resources.toByteArray(
                Resources.getResource(VetoDeleteOfIncomingDocumentIfCategorised_IntegTest.class, fileName));
    ...
    @Test
    public void can_delete_if_not_yet_categorized() throws Exception {
    ...
    @Test
    public void cannot_delete_if_categorized_as_incoming_invoice() throws Exception {
        cannot_delete_if_categorized_as(
                DocumentTypeData.INCOMING_INVOICE, "Document has already been categorized (as Incoming Invoice)");
    }

    @Test
    public void cannot_delete_if_categorized_as_incoming_order() throws Exception {
        cannot_delete_if_categorized_as(
                DocumentTypeData.INCOMING_ORDER, "Document has already been categorized (as Incoming Order)");
    }

    protected void cannot_delete_if_categorized_as(
