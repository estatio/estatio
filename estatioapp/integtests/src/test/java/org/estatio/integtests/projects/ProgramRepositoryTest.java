...
public class ProgramRepositoryTest extends EstatioIntegrationTest {
    ...
    public static class AllProgramRepository extends ProgramRepositoryTest {
    ...
    public static class FindProgramRepository extends ProgramRepositoryTest {
