...
public class LeaseItemRepositoryTest extends EstatioIntegrationTest {
    ...
    public static class FindLeaseItem extends LeaseItemRepositoryTest {
    ...
    public static class FindLeaseItemByType extends LeaseItemRepositoryTest {
