...
//                        () -> wrap(mixin(Task_categoriseAsOtherInvoice.class, task1))
...
//
//            // when
//            wrap(mixin(Task_categoriseAsOtherInvoice.class, task2))
...
//            assertThat(invoiceCreated.getPaymentMethod()).isEqualTo(PaymentMethod.MANUAL_PROCESS); // set by default
