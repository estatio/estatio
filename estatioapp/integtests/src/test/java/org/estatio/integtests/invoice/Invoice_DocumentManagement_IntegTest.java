...
import org.estatio.dom.leaseinvoicing.dnc.Invoice_attachReceipt;
import org.estatio.dom.leaseinvoicing.dnc.Invoice_createAndAttachDocument;
import org.estatio.dom.leaseinvoicing.dnc.Invoice_email;
import org.estatio.dom.leaseinvoicing.dnc.Invoice_print;
import org.estatio.dom.leaseinvoicing.viewmodel.dnc.DocAndCommForInvoiceDoc;
import org.estatio.dom.leaseinvoicing.viewmodel.dnc.DocAndCommForInvoiceDoc_communication;
import org.estatio.dom.leaseinvoicing.viewmodel.dnc.DocAndCommForInvoiceDoc_communicationState;
import org.estatio.dom.leaseinvoicing.viewmodel.dnc.DocAndCommForInvoiceDoc_document;
import org.estatio.dom.leaseinvoicing.viewmodel.dnc.DocAndCommForInvoiceDoc_documentState;
import org.estatio.dom.leaseinvoicing.viewmodel.dnc.DocAndCommForPrelimLetter;
import org.estatio.dom.leaseinvoicing.viewmodel.dnc.DocAndCommForPrelimLetter_communication;
import org.estatio.dom.leaseinvoicing.viewmodel.dnc.DocAndCommForPrelimLetter_communicationState;
import org.estatio.dom.leaseinvoicing.viewmodel.dnc.DocAndCommForPrelimLetter_document;
import org.estatio.dom.leaseinvoicing.viewmodel.dnc.DocAndCommForPrelimLetter_documentState;
import org.estatio.dom.leaseinvoicing.viewmodel.dnc.Invoice_invoiceDocs;
import org.estatio.dom.leaseinvoicing.viewmodel.dnc.Invoice_preliminaryLetters;
...
public class Invoice_DocumentManagement_IntegTest extends EstatioIntegrationTest {
    ...
    public static class Invoice_createAndAttachDocument_IntegTest extends Invoice_DocumentManagement_IntegTest {
        ...
        public static class ActionInvocationIntegTest extends
            ...
            public void for_invoice_doc() throws Exception {
                ...
                // when
                wrap(mixin(Invoice_createAndAttachDocument.class, invoice)).$$(invoiceDocTemplate);
    ...
    public static class Invoice_print_IntegTest extends Invoice_DocumentManagement_IntegTest {
        ...
        public void when_prelim_letter_any_invoice_receipts_attached_are_ignored() throws IOException {
            ...
            // when
            Blob downloaded = wrap(mixin(Invoice_print.class, invoice)).$$(document, sendTo);
