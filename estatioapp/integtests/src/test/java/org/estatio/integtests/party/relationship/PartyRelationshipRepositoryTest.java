...
public class PartyRelationshipRepositoryTest extends EstatioIntegrationTest {
    ...
    public static class AllRelationships extends PartyRelationshipRepositoryTest {
        @Test
    ...
    public static class FindByParty extends PartyRelationshipRepositoryTest {
        @Test
    ...
    public static class NewRelationship extends PartyRelationshipRepositoryTest {
    ...
    public static class NewRelatedPerson extends PartyRelationshipRepositoryTest {
    ...
    public static class OnPartyRemove extends PartyRelationshipRepositoryTest {
