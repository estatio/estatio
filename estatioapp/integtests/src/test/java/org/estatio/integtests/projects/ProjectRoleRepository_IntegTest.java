...
public class ProjectRoleRepository_IntegTest extends EstatioIntegrationTest {
    ...
    public static class FindRole extends ProjectRoleRepository_IntegTest {
    ...
    public static class newProjectRole extends ProjectRoleRepository_IntegTest {
    ...
    public static class changeProjectRoleDates extends ProjectRoleRepository_IntegTest {
    ...
    public static class OnPartyRemove extends ProjectRoleRepository_IntegTest {
