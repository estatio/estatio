...
public class ProjectRepositoryTest extends EstatioIntegrationTest {
    ...
    public static class AllProjects extends ProjectRepositoryTest {
    ...
    public static class FindProjects extends ProjectRepositoryTest {
    ...
    public static class updateDateOfProject extends ProjectRepositoryTest {
