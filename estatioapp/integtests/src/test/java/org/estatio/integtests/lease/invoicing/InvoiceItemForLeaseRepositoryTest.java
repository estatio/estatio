...
public class InvoiceItemForLeaseRepositoryTest extends EstatioIntegrationTest {
    ...
    public static class FindByLeaseRepositoryTerm extends InvoiceItemForLeaseRepositoryTest {
    ...
    public static class FindByLeaseRepositoryTermAndInterval extends InvoiceItemForLeaseRepositoryTest {
    ...
    public static class FindByLeaseTermAndIntervalAndInvoiceStatusRepository extends InvoiceItemForLeaseRepositoryTest {
    ...
    public static class FindByLeaseAndInvoiceStatusRepository extends InvoiceItemForLeaseRepositoryTest {
    ...
    public static class FindByLeaseItemAndInvoiceStatusRepository extends InvoiceItemForLeaseRepositoryTest {
    ...
    public static class FindByLeaseTermAndInvoiceStatusRepository extends InvoiceItemForLeaseRepositoryTest {
