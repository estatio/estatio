...
public class LeaseTermRepositoryTest extends EstatioIntegrationTest {
    ...
    public static class AllLeaseTermRepository extends LeaseTermRepositoryTest {
    ...
    public static class FindByPropertyAndTypeAndStartDate extends LeaseTermRepositoryTest {
    ...
    public static class FindStartDatesByPropertyAndType extends LeaseTermRepositoryTest {
    ...
    public static class NewLeaseTermWithMandatoryEndDate extends LeaseTermRepositoryTest {
