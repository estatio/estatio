...
public class UnitRepositoryTest extends EstatioIntegrationTest {
    ...
    public static class FindUnitByReference extends UnitRepositoryTest {
    ...
    public static class FindByPropertyAndActiveOnDate extends UnitRepositoryTest {
    ...
    public static class FindByProperty extends UnitRepositoryTest {
