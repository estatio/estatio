...
public class LeaseTerm_UnitTest {
    ...
    public static class CreateNext extends LeaseTerm_UnitTest {
    ...
    public static class Update extends LeaseTerm_UnitTest {
    ...
    public static class InvoicedValueFor extends LeaseTerm_UnitTest {
    ...
    public static class EffectiveInterval extends LeaseTerm_UnitTest {
    ...
    public static class NextStartDate extends LeaseTerm_UnitTest {
    ...
    public static class ValidateCreateNext extends LeaseTerm_UnitTest {
    ...
    public static class ChangeDates extends LeaseTerm_UnitTest {
