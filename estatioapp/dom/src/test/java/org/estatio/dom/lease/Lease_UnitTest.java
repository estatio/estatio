...
import org.estatio.dom.agreement.Agreement_UnitTest;
...
public class Lease_UnitTest {
    ...
    public static class ChangeStatus extends Lease_UnitTest {
    ...
    public static class GetEffectiveInterval extends Lease_UnitTest {
    ...
    public static class NewItem extends Lease_UnitTest {
    ...
    public static class DisableNewItem extends Lease_UnitTest {
    ...
    public static class DefaultPaymentMehodForNewItem extends Lease_UnitTest {
    ...
    public static class ChangePaymentMethodForAll extends Lease_UnitTest {
    ...
    public static class NewMandate extends Lease_UnitTest {
    ...
    public static class PaidBy extends Lease_UnitTest {
    ...
    public static class TenancyDuration extends Lease_UnitTest {
    ...
    public static class ValidateChangePrevious extends Agreement_UnitTest {
    ...
    public static class Renew extends Lease_UnitTest {
    ...
    public static class RenewKeepingThis extends Lease_UnitTest {
