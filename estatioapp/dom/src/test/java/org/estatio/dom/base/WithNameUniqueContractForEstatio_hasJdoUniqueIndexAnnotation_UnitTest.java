...
public class WithNameUniqueContractForEstatio_hasJdoUniqueIndexAnnotation_UnitTest extends
        WithFieldUniqueContractTestAllAbstract<WithNameUnique> {

    public WithNameUniqueContractForEstatio_hasJdoUniqueIndexAnnotation_UnitTest() {
        super(WithNameUnique.class, "name", "org.estatio");
    }
