...
public class Invoice_UnitTest {
    ...
    public static class AssignInvoiceNumber extends Invoice_UnitTest {
    ...
    public static class Collect extends Invoice_UnitTest {
    ...
    public static class ValidInvoiceDate extends Invoice_UnitTest {
    ...
    public static class NewItem extends Invoice_UnitTest {
    ...
    public static class ValidateNewItemWithEmptyDates extends Invoice_UnitTest {
    ...
    public static class ValidateNewItemWithEmptyStartDate extends Invoice_UnitTest {
