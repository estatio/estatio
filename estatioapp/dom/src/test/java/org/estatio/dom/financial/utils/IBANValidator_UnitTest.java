...
public class IBANValidator_UnitTest {

    public static class Valid extends IBANValidator_UnitTest {
    ...
    public static class Checksum extends IBANValidator_UnitTest {
    ...
    public static class FixChecksum extends IBANValidator_UnitTest {
