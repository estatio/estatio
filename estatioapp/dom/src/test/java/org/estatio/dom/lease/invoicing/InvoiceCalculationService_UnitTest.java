...
public class InvoiceCalculationService_UnitTest {

    public static abstract class CalculateDueDateRange extends InvoiceCalculationService_UnitTest {
    ...
    public static class CalculateDateRange extends InvoiceCalculationService_UnitTest {
