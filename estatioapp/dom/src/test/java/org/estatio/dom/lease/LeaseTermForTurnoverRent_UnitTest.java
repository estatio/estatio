...
public class LeaseTermForTurnoverRent_UnitTest {
    ...
    public static class DoAlign extends LeaseTermForTurnoverRent_UnitTest {
    ...
    public static class DoInitialize extends LeaseTermForTurnoverRent_UnitTest {
    ...
    public static class ValidateTurnoverRentRule extends LeaseTermForTurnoverRent_UnitTest {
