...
public class BankAccount_UnitTest {
    ...
    public static class CheckAccount extends BankAccount_UnitTest {
    ...
    public static class Change extends BankAccount_UnitTest {
    ...
    public static class VerifyIban extends BankAccount_UnitTest {
        ...
        /**
         * See also {@link IBANHelper_UnitTest}
         */
        @Test
