...
public class BidirectionalRelationshipContractForEstatio_UnitTest extends BidirectionalRelationshipContractTestAbstract {

    public BidirectionalRelationshipContractForEstatio_UnitTest() {
        super("org.estatio",
