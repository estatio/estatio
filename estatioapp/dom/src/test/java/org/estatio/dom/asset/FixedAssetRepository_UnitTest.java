...
public class FixedAssetRepository_UnitTest {
    ...
    public static class FindAssetRepositoryByReferenceOrName extends FixedAssetRepository_UnitTest {
    ...
    public static class AutoComplete extends FixedAssetRepository_UnitTest {
