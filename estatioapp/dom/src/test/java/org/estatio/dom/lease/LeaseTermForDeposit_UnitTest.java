...
public class LeaseTermForDeposit_UnitTest {
    ...
    public static class ValueForDate extends LeaseTermForDeposit_UnitTest {
    ...
    public static class IncludeAndExcludeVAT extends LeaseTermForDeposit_UnitTest {
    ...
    public static class WithFixedCalculationDate extends LeaseTermForDeposit_UnitTest {
    ...
    public static class VerifyUntil extends LeaseTermForDeposit_UnitTest {
    ...
    public static class CopyValuesTo extends LeaseTermForDeposit_UnitTest {
