...
public class BudgetCalculationRepository_UnitTest {
    ...
    public static class FindByPartitionItemAndKeyItemAndCalculationType extends BudgetCalculationRepository_UnitTest {
    ...
    public static class FindByBudgetAndStatus extends BudgetCalculationRepository_UnitTest {
    ...
    public static class FindByPartitionItemAndCalculationType extends BudgetCalculationRepository_UnitTest {
    ...
    public static class FindByPartitionItem extends BudgetCalculationRepository_UnitTest {
    ...
    public static class FindByBudgetAndInvoiceChargeAndType extends BudgetCalculationRepository_UnitTest {
    ...
    public static class UpdateOrCreateWithoutExisting extends BudgetCalculationRepository_UnitTest {
