...
public class BudgetItemRepository_UnitTest {
    ...
    public static class FindByBudget extends BudgetItemRepository_UnitTest {
    ...
    public static class FindByBudgetAndCharge extends BudgetItemRepository_UnitTest {
    ...
    public static class FindByPropertyAndChargeAndStartDate extends BudgetItemRepository_UnitTest {
    ...
    public static class FindOrCreateBudgetItemCreatingNewItem extends BudgetItemRepository_UnitTest {
