...
public class Property_UnitTest {
    ...
    public static class LookupLocation extends Property_UnitTest {
    ...
    public static class NewUnit extends Property_UnitTest {
    ...
    public static class ValidateAddOwner extends Property_UnitTest {
    ...
    public static class Dispose extends Property_UnitTest {
        private Property property;
    ...
    public static class Ordering extends Property_UnitTest {
