...
public class WithTitleUniqueContractForEstatio_hasJdoUniqueIndexAnnotation_UnitTest extends
        WithFieldUniqueContractTestAllAbstract<WithTitleUnique> {

    public WithTitleUniqueContractForEstatio_hasJdoUniqueIndexAnnotation_UnitTest() {
