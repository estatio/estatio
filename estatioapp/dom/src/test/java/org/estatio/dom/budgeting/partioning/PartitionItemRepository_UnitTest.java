...
public class PartitionItemRepository_UnitTest {
    ...
    public static class FindByPartitionItem extends PartitionItemRepository_UnitTest {
    ...
    public static class FindByKeyTable extends PartitionItemRepository_UnitTest {
    ...
    public static class FindUnique extends PartitionItemRepository_UnitTest {
    ...
    public static class FindOrCreatePartitionItemNew extends PartitionItemRepository_UnitTest {
