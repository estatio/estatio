...
public class InvoiceRepository_UnitTest {
    ...
    public static class FindMatchingInvoices extends InvoiceRepository_UnitTest {
    ...
    public static class AllInvoices extends InvoiceRepository_UnitTest {
    ...
    public static class FindXxxNumerator extends InvoiceRepository_UnitTest {
