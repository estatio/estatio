...
public class Index_UnitTest {
    ...
    public static class FactorForDate extends Index_UnitTest {
    ...
    public static class GetIndexValueFactorForDate extends Index_UnitTest {
    ...
    public static class GetRebaseFactorForDates extends Index_UnitTest {
