 ...
 */
public class BudgetKeyItemsTest {

    BudgetKeyItems budgetKeyItems = new BudgetKeyItems();

    @Test
    public void zeroSourceValue() {

        //given
        BudgetKeyTable budgetKeyTable = new BudgetKeyTableForTesting();
        Unit unit = new UnitForTesting();
        BigDecimal sourcevalue = BigDecimal.ZERO;
        BigDecimal keyValue = new BigDecimal(10);

        //when
        String validateNewBudgetKeyItem = budgetKeyItems.validateNewBudgetKeyItem(
                budgetKeyTable,
                unit,
                sourcevalue,
                keyValue);
