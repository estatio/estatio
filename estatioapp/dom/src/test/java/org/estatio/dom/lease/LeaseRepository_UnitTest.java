...
public class LeaseRepository_UnitTest {
    ...
    public static class FindLeaseByReference extends LeaseRepository_UnitTest {
        @Test
    ...
    public static class findLeases extends LeaseRepository_UnitTest {
    ...
    public static class FindLeasesByProperty extends LeaseRepository_UnitTest {
    ...
    public static class FindLeasesActiveOnDate extends LeaseRepository_UnitTest {
    ...
    public static class AllLeases extends LeaseRepository_UnitTest {
