 ...
 */
public class DomainServicesInjectionForEstatio_Test extends
        DomainServicesInjection_inject_ContractTestAbstract {

    public DomainServicesInjectionForEstatio_Test() {
        super("org.estatio");
    }
