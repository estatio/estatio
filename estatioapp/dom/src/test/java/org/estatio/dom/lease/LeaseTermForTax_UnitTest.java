...
public class LeaseTermForTax_UnitTest {

    public static final String VALUE = "12345.67";

    public static class ChangeRegistration extends LeaseTermForTax_UnitTest {
    ...
    public static class DoAlign extends LeaseTermForTax_UnitTest {
    ...
    public static class ChangeTax extends LeaseTermForTax_UnitTest {
    ...
    public static class ChangeInvoice extends LeaseTermForTax_UnitTest {
    ...
    public static class AllowsOpenEndate extends LeaseTermForTax_UnitTest {
