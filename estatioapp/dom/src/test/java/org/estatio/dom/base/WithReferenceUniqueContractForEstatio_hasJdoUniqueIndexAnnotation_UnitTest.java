...
public class WithReferenceUniqueContractForEstatio_hasJdoUniqueIndexAnnotation_UnitTest extends
        WithFieldUniqueContractTestAllAbstract<WithReferenceUnique> {

    public WithReferenceUniqueContractForEstatio_hasJdoUniqueIndexAnnotation_UnitTest() {
