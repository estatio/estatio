...
public class PartitioningRepository_UnitTest {
    ...
    public static class FindUnique extends PartitioningRepository_UnitTest {
    ...
    public static class FindByBudgetAndType extends PartitioningRepository_UnitTest {
    ...
    public static class NewPartitioning extends PartitioningRepository_UnitTest {
