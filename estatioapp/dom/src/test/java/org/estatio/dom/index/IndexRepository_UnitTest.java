...
public class IndexRepository_UnitTest {
    ...
    public static class FindIndexByReference extends IndexRepository_UnitTest {
    ...
    public static class AllIndices extends IndexRepository_UnitTest {
