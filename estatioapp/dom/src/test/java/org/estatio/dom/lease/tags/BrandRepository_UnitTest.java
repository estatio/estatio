...
public class BrandRepository_UnitTest {
    ...
    public static class FindUnique extends BrandRepository_UnitTest {
    ...
    public static class MatchByName extends BrandRepository_UnitTest {
        @Test
    ...
    public static class FindByNameLowerCaseAndAppTenancy extends BrandRepository_UnitTest {
    ...
    public static class AutoComplete extends BrandRepository_UnitTest {
