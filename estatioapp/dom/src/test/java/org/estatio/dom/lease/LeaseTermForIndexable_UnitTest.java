...
public class LeaseTermForIndexable_UnitTest {
    ...
    public static class DoAlign extends LeaseTermForIndexable_UnitTest {
    ...
    public static class ValueForDueDate extends LeaseTermForIndexable_UnitTest {
    ...
    public static class DoInitialize extends LeaseTermForIndexable_UnitTest {
