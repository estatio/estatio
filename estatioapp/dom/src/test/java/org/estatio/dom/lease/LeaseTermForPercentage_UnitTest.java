...
public class LeaseTermForPercentage_UnitTest {
    ...
    public static class DoAlign extends LeaseTermForPercentage_UnitTest {
    ...
    public static class ValidateChangePercentage extends LeaseTermForPercentage_UnitTest {
    ...
    public static class DoInitialize extends LeaseTermForPercentage_UnitTest {
