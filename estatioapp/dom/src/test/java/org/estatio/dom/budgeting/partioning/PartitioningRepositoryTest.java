...
public class PartitioningRepositoryTest {
    ...
    public static class FindUnique extends PartitioningRepositoryTest {
    ...
    public static class FindByBudgetAndType extends PartitioningRepositoryTest {
    ...
    public static class NewPartitioning extends PartitioningRepositoryTest {
