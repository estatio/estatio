...
public class LeaseTermRepository_UnitTest {
    ...
    public static class FindByLeaseItemAndSequence extends LeaseTermRepository_UnitTest {
    ...
    public static class LeaseTermsToBeApproved extends LeaseTermRepository_UnitTest {
    ...
    public static class AllInvoices extends LeaseTermRepository_UnitTest {
    ...
    public static class ValidateNewLeaseTerm extends LeaseTermRepository_UnitTest {
