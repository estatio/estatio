...
public class FixedAssetRepository_Test {
    ...
    public static class FindAssetRepositoryByReferenceOrName extends FixedAssetRepository_Test {
    ...
    public static class AutoComplete extends FixedAssetRepository_Test {
