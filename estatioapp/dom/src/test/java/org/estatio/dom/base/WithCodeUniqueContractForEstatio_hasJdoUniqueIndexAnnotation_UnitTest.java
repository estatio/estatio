...
public class WithCodeUniqueContractForEstatio_hasJdoUniqueIndexAnnotation_UnitTest extends
        WithFieldUniqueContractTestAllAbstract<WithCodeUnique> {

    public WithCodeUniqueContractForEstatio_hasJdoUniqueIndexAnnotation_UnitTest() {
        super(WithCodeUnique.class, "code", "org.estatio");
    }
