...
public class LeaseTermForTurnoverRent_Test {
    ...
    public static class DoAlign extends LeaseTermForTurnoverRent_Test {
    ...
    public static class DoInitialize extends LeaseTermForTurnoverRent_Test {
    ...
    public static class ValidateTurnoverRentRule extends LeaseTermForTurnoverRent_Test {
