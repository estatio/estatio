...
public class LeaseItem_UnitTest {
    ...
    public static class GetCurrentValue extends LeaseItem_UnitTest {
    ...
    public static class Remove extends LeaseItem_UnitTest {
    ...
    public static class ToString extends LeaseItem_UnitTest {
    ...
    public static class ChoicesNewSourceItem extends LeaseItem_UnitTest {
