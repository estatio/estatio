...
public class KeytableRepository_UnitTest {
    ...
    public static class FindByPropertyAndNameAndStartDate extends KeytableRepository_UnitTest {
    ...
    public static class FindByBudget extends KeytableRepository_UnitTest {
    ...
    public static class NewKeyTable extends KeytableRepository_UnitTest {
