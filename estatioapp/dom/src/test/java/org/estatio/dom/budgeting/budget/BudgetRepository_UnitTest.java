...
public class BudgetRepository_UnitTest {
    ...
    public static class FindByProperty extends BudgetRepository_UnitTest {
    ...
    public static class FindByPropertyAndDates extends BudgetRepository_UnitTest {
    ...
    public static class NewBudget extends BudgetRepository_UnitTest {
