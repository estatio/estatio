...
public class TurnoverRentRuleHelper_UnitTest {

    public static class CalculateRent extends TurnoverRentRuleHelper_UnitTest {
    ...
    public static class IsValid extends TurnoverRentRuleHelper_UnitTest {
