...
public class OccupancyRepository_UnitTest {
    ...
    public static class FindByLeaseAndUnitAndStartDate extends OccupancyRepository_UnitTest {
        @Test
    ...
    public static class FindByLease extends OccupancyRepository_UnitTest {
    }
    ...
    public static class FindByUnit extends OccupancyRepository_UnitTest {
    ...
    public static class occupanciesByUnitAndInterval extends OccupancyRepository_UnitTest {
