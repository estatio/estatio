...
public class LeaseTermForServiceCharge_UnitTest {
    ...
    public static class Align extends LeaseTermForServiceCharge_UnitTest {
    ...
    public static class ValueForDate extends LeaseTermForServiceCharge_UnitTest {
    ...
    public static class AllowsOpenEndate extends LeaseTermForServiceCharge_UnitTest {
