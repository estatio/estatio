...
public class BankAccountPayloadFactory implements PayloadFactory {
    ...
    public EventPayload payloadFor(
            ...
            final Object result) {
        List<BankMandate> mandates = bankMandates.findBankMandatesFor((BankAccount)target);
        return new BankAccountPayload(actionIdentifier, (BankAccount) target, arguments, result, mandates);
    }
