/**
 * Defines {@link org.estatio.dom.leaseinvoicing.InvoiceItemForLease}, which extends the
 * <tt>invoice</tt> module's {@link org.estatio.dom.invoice.InvoiceItem} and 
 * {@link org.estatio.dom.leaseinvoicing.InvoiceItemForLease#getLeaseTerm() associates} it with a
 * {@link org.estatio.dom.lease.LeaseTerm}.
 * 
 * <p>
 * The <tt>lease</tt> module depends on the <tt>invoice</tt> module, but - to minimize coupling - 
 * the latter is not true.  The {@link org.estatio.dom.leaseinvoicing.InvoiceItemForLease} enables a many-to-many
