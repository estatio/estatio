...
public class OnBudgetContributions {
    ...
    public KeyTable createKeyTable(final Budget budget,
        ...
        return keyTableRepository.newKeyTable(budget.getProperty(), name, budget.getStartDate(), budget.getEndDate(), foundationValueType, keyValueMethod, numberOfDigits);
    }
    ...
    public String validateCreateKeyTable(final Budget budget,
                                         ...
                                         final KeyValueMethod keyValueMethod,
                                         final Integer numberOfDigits) {
        return keyTableRepository.validateNewKeyTable(budget.getProperty(), name, budget.getStartDate(), budget.getEndDate(), foundationValueType, keyValueMethod, numberOfDigits);
    }
