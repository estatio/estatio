 ...
 * Also defines {@link org.estatio.dom.financial.BankMandate}, being a means by which one party can pay another (in
 * other words, a direct debit.
 * 
 * <p>
 * {@link org.estatio.dom.financial.BankMandate} is a particular (sub)type of
 ...
 * {@link org.estatio.dom.financial.BankAccount} in order that a {@link org.estatio.dom.financial.BankMandate} can
