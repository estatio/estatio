...
@Discriminator("LTRI")
public class TurnoverRentLeaseTerm extends LeaseTerm implements Indexable{
    ...
    // {{
    public TurnoverRentLeaseTerm createNextLeaseTerm(@Named("Start Date") LocalDate startDate, BigDecimal value) {

        // create new term
        TurnoverRentLeaseTerm term = (TurnoverRentLeaseTerm) getNextTerm();
        if (getNextTerm() == null) {
