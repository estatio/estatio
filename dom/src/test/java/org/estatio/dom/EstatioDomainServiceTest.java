...
public class EstatioDomainServiceTest {

    public static class AllInstances_etc extends EstatioDomainServiceTest {
    ...
    public static class GetId_and_IconName extends EstatioDomainServiceTest {
