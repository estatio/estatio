...
public class UnitTest_beanProperties {
	...
	public void test() {
		new PojoTester()
			...
			.exercise(new Unit(), FilterSet.excluding("container", "isisJdoSupport", "leases", "communicationChannels", "countries", "locationLookupService", "location", "fixedAssetRolesRepo", "roles", "parties"));
	}
