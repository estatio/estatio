...
public class EntityLinkWithAutoCompleteFactory extends ComponentFactoryAbstract {

    private static final long serialVersionUID = 1L;

    public EntityLinkWithAutoCompleteFactory() {
    ...
    public Component createComponent(final String id, final IModel<?> model) {
        final EntityModel entityModel = (EntityModel) model;
        return new EntityLinkWithAutoComplete(id, entityModel);
    }
}
