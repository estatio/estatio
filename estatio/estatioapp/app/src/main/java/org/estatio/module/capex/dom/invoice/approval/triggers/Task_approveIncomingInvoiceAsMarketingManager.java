 ...
 */
@Mixin(method = "act")
public class Task_approveIncomingInvoiceAsMarketingManager
        extends Task_mixinIncomingInvoiceAbstract<IncomingInvoice_approveAsMarketingManager> {

    protected final Task task;

    public Task_approveIncomingInvoiceAsMarketingManager(final Task task) {
        super(task, IncomingInvoice_approveAsMarketingManager.class);
        this.task = task;
    }

    public static class ActionDomainEvent
            extends Task_mixinIncomingInvoiceAbstract.ActionDomainEvent<Task_approveIncomingInvoiceAsMarketingManager> { }
