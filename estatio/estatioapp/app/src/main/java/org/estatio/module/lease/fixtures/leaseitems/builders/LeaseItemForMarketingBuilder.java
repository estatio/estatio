...
public class LeaseItemForMarketingBuilder extends BuilderScriptAbstract<LeaseItem, LeaseItemForMarketingBuilder> {

    public static final LeaseItemType LEASE_ITEM_TYPE = LeaseItemType.MARKETING;
    ...
    @Getter List<LeaseTermForServiceCharge> terms = Lists.newArrayList();
