...
public class LeaseItemForRentBuilder extends BuilderScriptAbstract<LeaseItem, LeaseItemForRentBuilder> {

    public static final LeaseItemType LEASE_ITEM_TYPE = LeaseItemType.RENT;
    ...
    protected void execute(final ExecutionContext ec) {
        ...
        for (LeaseTermForIndexableBuilder.TermSpec termSpec : termSpecs) {
            final LeaseTermForIndexable term = new LeaseTermForIndexableBuilder()
                    ...
                    .setEffectiveDate(termSpec.endDate)
