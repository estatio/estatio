...
public class LeaseTermForDepositBuilder
        extends BuilderScriptAbstract<LeaseTermForDeposit, LeaseTermForDepositBuilder> {
    ...
    @Getter @Setter Fraction fraction;
    ...
    @Getter LeaseTermForDeposit object;
