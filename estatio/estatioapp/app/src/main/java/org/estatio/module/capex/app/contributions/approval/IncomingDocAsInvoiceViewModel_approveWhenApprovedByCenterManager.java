 ...
 */
@Mixin(method = "act")
public class IncomingDocAsInvoiceViewModel_approveWhenApprovedByCenterManager
                    extends IncomingInvoice_approveWhenApprovedByCenterManager {

    private final IncomingDocAsInvoiceViewModel viewModel;

    public IncomingDocAsInvoiceViewModel_approveWhenApprovedByCenterManager(final IncomingDocAsInvoiceViewModel viewModel) {
    ...
    public static class ActionDomainEvent
            extends
            IncomingInvoice_triggerAbstract.ActionDomainEvent<IncomingDocAsInvoiceViewModel_approveWhenApprovedByCenterManager> {}
