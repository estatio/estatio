...
public abstract class TurnoverModuleIntegTestAbstract extends BaseModuleIntegTestAbstract {

    public TurnoverModuleIntegTestAbstract() {
        super(new EstatioTurnoverModule());
    }
