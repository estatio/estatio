 ...
 *  under the License.
 */
package org.estatio.module.lease.integtests.settings;
...
public class EstatioApplicationSettingsService_IntegTest extends LeaseModuleIntegTestAbstract {
    ...
    public static class ListAll extends EstatioApplicationSettingsService_IntegTest {
        ...
        public void happyCase() throws Exception {
            ...
            // Then
            assertThat(applicationSettings.size()).isEqualTo(4);
        }
    }
