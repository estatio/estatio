 ...
 */
public abstract class DomainServicesInjection_inject_ContractTestAbstract {

    private final String prefix;

    protected DomainServicesInjection_inject_ContractTestAbstract(final String prefix) {
        this.prefix = prefix;
    }
