...
import static org.estatio.module.coda.dom.doc.ValidationStatus.NOT_CHECKED;
...
public class ValidationStatus_deriveFrom_Test {
    ...
    @Test
    public void when_one_is_not_checked() {
        assertThat(ValidationStatus.deriveFrom(VALID, NOT_CHECKED, VALID)).isEqualTo(INVALID);
    }
