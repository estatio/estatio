...
public abstract class BudgetAssignmentModuleIntegTestAbstract extends BaseModuleIntegTestAbstract {

    public BudgetAssignmentModuleIntegTestAbstract() {
        super(new EstatioBudgetAssignmentModule());
    }
}