...
The diagrams below represent the "to be" case; still to do:

* move apptenancy from udo to icm
* move docrendering modules from estatio to icm
* move communications from udo to icm


==== Estatio OS

[plantuml, docs/images/estatio, png]
....
...
package "incode-modules" {
    ...
    [icm-apptenancy] --> [icm-base]
    [icm-classification] --> [icm-base]
    [icm-communications] --> [icm-country]
    [icm-communications] --> [icm-apptenancy]
}


[estatio-dom] --> [icm-communications]
[estatio-dom] --> [icm-documents]
[estatio-dom] --> [icm-classification]
[udo-charge] --> [icm-apptenancy]
[udo-partyagreement] --> [icm-apptenancy]
...
[plantuml, docs/images/incode-and-isisaddons, png]
....
package "incode-modules" {
    ...
    [icm-communication] --> [icm-document]
    [icm-communication] --> [icm-country]

    package "docrendering" {
        [icm-docrendering\n-freemarker] -up-> [icm-document]
        [icm-docrendering\n-stringinterpolator] -up-> [icm-document]
        [icm-docrendering\n-xdocreport] -up-> [icm-document]
    }
}
